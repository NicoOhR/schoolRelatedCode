...
\usepackage{latexsym, mathtools, amsfonts,amssymb,amsthm,amsmath}
...
\begin{proof}
  ...
  Define $\{r_n\}$ as $\{\frac{\lfloor na\rfloor}{n}\}$ which is obviously in $\mathbb{Q}$.
  Then, to show convergance: 
  \begin{align*}
    \lfloor na \rfloor &\leq na  < \lfloor na \rfloor + 1 \\ 
    \frac{\lfloor na \rfloor}{n} &\leq a < \frac{\lfloor na \rfloor + 1}{n} \\ 
    0 &\leq a - \frac{\lfloor na \rfloor}{n} < \frac{1}{n} \\ 
    0 &\leq \mid \frac{\lfloor na \rfloor}{n} - a \mid < \mid \frac{1}{n}\mid
  \end{align*}
  So for any $\epsilon > 0$ simply choose $N = \frac1\varepsilon$
\end{proof}
\end{document}
