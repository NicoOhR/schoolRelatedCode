...
\begin{proof}
  $\partial(\partial A) = \overline {\partial A} \cup \text{Int}(\partial A)$, however since $\partial A$ is closed, and the closure of a closed set is itsefl, $\overline{\partial A} = \partial A$. Therefore $$\partial(\partial A) = \partial A \cup \text{Int}(\partial A) \implies \partial(\partial A) \subseteq \partial A$$
\end{proof}
